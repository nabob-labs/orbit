...
// HE	Orbit Error	Errors originating from Orbit's end
...
pub enum ApiErrorResponse {
    ...
    #[error(error_type = ErrorType::ValidationError, code = "HE_03", message = "This refund is not possible through Orbit. Please raise the refund through {connector} dashboard")]
    ...
    fn switch(&self) -> api_models::errors::types::ApiErrorResponse {
        ...
        match self {
            ...
            Self::RefundNotPossible { connector } => {
                AER::BadRequest(ApiError::new("HE", 3, format!("This refund is not possible through Orbit. Please raise the refund through {connector} dashboard"), None))
            }
