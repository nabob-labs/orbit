...
pub struct ConnectorConfig {
    pub bospaythreedsserver: Option<ConnectorTomlConfig>,
...
impl ConnectorConfig {
    ...
    pub fn get_authentication_connector_config(
        ...
        match connector {
            ...
            AuthenticationConnectors::Bospaythreedsserver => Ok(connector_data.bospaythreedsserver),
        }
    }
    ...
    pub fn get_connector_config(
        ...
        match connector {
            ...
            Connector::Bospaythreedsserver => Ok(connector_data.bospaythreedsserver),
