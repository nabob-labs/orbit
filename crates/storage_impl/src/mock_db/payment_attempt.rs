...
#[cfg(feature = "v2")]
use orbit_domain_models::merchant_key_store::MerchantKeyStore;
#[cfg(feature = "v1")]
use orbit_domain_models::payments::payment_attempt::PaymentAttemptNew;
...
impl PaymentAttemptInterface for MockDb {
    ...
    async fn get_filters_for_payments(
        &self,
        _pi: &[orbit_domain_models::payments::PaymentIntent],
        _merchant_id: &common_utils::id_type::MerchantId,
        _storage_scheme: storage_enums::MerchantStorageScheme,
    ) -> CustomResult<
