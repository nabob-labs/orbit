...
#[openapi(
    info(
        ...
        contact(
            name = "Orbit Support",
            url = "https://orbit.io",
            email = "mailto:orbit@xyz.in"
        ),
        // terms_of_service = "https://www.bospay.io/terms",
        description = r#"
## Get started

Orbit provides a collection of APIs that enable you to process and manage payments.
...
You can sign up on our Dashboard to get API keys to access Orbit API.
...
|---------------|------------------------------------|
| Sandbox       | <https://sandbox.orbit.io>   |
| Production    | <https://api.orbit.io>       |

## Authentication

When you sign up on our [dashboard](https://app.orbit.io) and create a merchant
account, you are given a secret key (also referred as api-key) and a publishable key.
You may authenticate all API requests with Orbit server by providing the appropriate key in
...
"#,
    ...
    servers(
        (url = "https://sandbox.orbit.io", description = "Sandbox Environment")
    ),
    tags(
            ...
            components.add_security_schemes_from_iter([
                (
                    ...
                    SecurityScheme::ApiKey(ApiKey::Header(ApiKeyValue::with_description(
                        "api-key",
                        "Use the API key created under your merchant account from the Orbit dashboard. API key is used to authenticate API requests from your merchant server only. Don't expose this key on a website or embed it in a mobile application."
                    ))),
                ),
                (
                    "admin_api_key",
