//! This module has common utilities for links in Orbit
...
pub struct GenericLinkUiConfig {
    ...
    #[schema(value_type = Option<String>, max_length = 255, example = "https://orbit.io/favicon.ico")]
...
pub struct GenericLinkUiConfigFormData {
    /// Merchant's display logo
    #[schema(value_type = String, max_length = 255, example = "https://orbit.io/favicon.ico")]
    pub logo: url::Url,

    /// Custom merchant name for the link
    #[schema(value_type = String, max_length = 255, example = "Orbit")]
