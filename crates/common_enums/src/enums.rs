...
/// - On_session - Payment method saved only at orbit when consent is provided by the user. CVV will asked during the returning user payment
/// - Off_session - Payment method saved at both orbit and Processor when consent is provided by the user. No input is required during the returning user payment.
#[derive(
    Clone,
    Copy,
    Debug,
...
impl AuthenticationConnectors {
    pub fn is_separate_version_call_required(self) -> bool {
        match self {
            ...
            | Self::Bospaythreedsserver => false,
            Self::Gpayments => true,
        }
    }
}
...
/// Name of banks supported by Orbit
#[derive(
    Clone,
    Copy,
    Debug,
