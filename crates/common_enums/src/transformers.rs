...
mod tests {
    ...
    struct OrbitRequestAlpha2 {
        #[serde(with = "custom_serde::alpha2_country_code")]
        pub country: Country,
    }

    #[derive(serde::Serialize, serde::Deserialize)]
    struct OrbitRequestAlpha3 {
        #[serde(with = "custom_serde::alpha3_country_code")]
        pub country: Country,
    }

    #[derive(serde::Serialize, serde::Deserialize, Debug)]
    struct OrbitRequestNumeric {
        #[serde(with = "custom_serde::numeric_country_code")]
        pub country: Country,
    }
    ...
    fn test_deserialize_alpha2() {
        ...
        let request = serde_json::from_str::<OrbitRequestAlpha2>(request_str).unwrap();
    ...
    fn test_deserialize_alpha3() {
        ...
        let request = serde_json::from_str::<OrbitRequestAlpha3>(request_str).unwrap();
        assert_eq!(request.country, Country::India);
    ...
    fn test_deserialize_numeric() {
        ...
        let request = serde_json::from_str::<OrbitRequestNumeric>(request_str).unwrap();
        assert_eq!(request.country, Country::India);
    ...
    fn test_serialize_and_deserialize() {
        ...
        let result = serde_json::from_str::<OrbitRequestAlpha3>(response.as_str()).unwrap();
    ...
    fn test_deserialize_invalid_country_code() {
        ...
        let result: Result<OrbitRequestNumeric, _> =
            serde_json::from_str::<OrbitRequestNumeric>(request_str);
