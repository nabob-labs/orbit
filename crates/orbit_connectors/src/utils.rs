...
use orbit_interfaces::{api, consts, errors, types::Response};
...
impl<Flow, Request, Response> RouterData
    for orbit_domain_models::router_data::RouterData<Flow, Request, Response>
{
    fn get_billing(&self) -> Result<&Address, Error> {
        self.address
...
#[cfg(feature = "payouts")]
impl PayoutFulfillRequestData for orbit_domain_models::router_request_types::PayoutsData {
    fn get_connector_payout_id(&self) -> Result<String, Error> {
...
mod tests {
    ...
    fn test_image_data_source_url() {
        let qr_image_data_source_url = utils::QrImage::new_from_data("Orbit".to_string());
...
pub trait PayoutsData {
    ...
    fn get_customer_details(
        &self,
    ) -> Result<orbit_domain_models::router_request_types::CustomerDetails, Error>;
...
#[cfg(feature = "payouts")]
impl PayoutsData for orbit_domain_models::router_request_types::PayoutsData {
    fn get_transfer_id(&self) -> Result<String, Error> {
        self.connector_payout_id
            .clone()
