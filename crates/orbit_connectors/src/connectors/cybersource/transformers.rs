...
fn build_bill_to(
    address_details: Option<&orbit_domain_models::address::Address>,
    email: pii::Email,
) -> Result<BillTo, error_stack::Report<errors::ConnectorError>> {
...
impl
    TryFrom<(
        &CybersourceRouterData<&PaymentsAuthorizeRouterData>,
        orbit_domain_models::payment_method_data::Card,
...
impl
    TryFrom<(
        &CybersourceRouterData<&PaymentsAuthorizeRouterData>,
        Box<orbit_domain_models::router_data::PazeDecryptedData>,
    )> for CybersourcePaymentsRequest
{
    type Error = error_stack::Report<errors::ConnectorError>;
    fn try_from(
...
fn get_samsung_pay_fluid_data_value(
    samsung_pay_token_data: &orbit_domain_models::payment_method_data::SamsungPayTokenData,
            ...
            CybersourceAuthSetupResponse::ErrorInformation(error_response) => {
                ...
                Ok(Self {
                    response: Err(ErrorResponse {
                        code: error_message
                            .clone()
                            .unwrap_or(orbit_interfaces::consts::NO_ERROR_CODE.to_string()),
                        message: error_message.unwrap_or(
                            orbit_interfaces::consts::NO_ERROR_MESSAGE.to_string(),
                        ),
                        reason,
            ...
            CybersourcePreProcessingResponse::ErrorInformation(error_response) => {
                ...
                let response = Err(ErrorResponse {
                    ...
                    message: error_message
                        .unwrap_or(orbit_interfaces::consts::NO_ERROR_MESSAGE.to_string()),
                    reason,
                    status_code: item.http_code,
                    attempt_status: None,
                    connector_transaction_id: Some(error_response.id.clone()),
...
pub fn get_error_response(
    ...
    ErrorResponse {
        code: error_message
            .clone()
            .unwrap_or_else(|| orbit_interfaces::consts::NO_ERROR_CODE.to_string()),
        message: error_message
            .unwrap_or_else(|| orbit_interfaces::consts::NO_ERROR_MESSAGE.to_string()),
        reason,
        status_code,
        attempt_status,
