    ...
    )> for RazorpayPaymentsRequest
{
    ...
    fn try_from(
        ...
        let merchant_data = BospayAuthData::try_from(data)?;
...
pub struct BospayAuthData {
    pub(super) merchant_id: Secret<String>,
}
impl TryFrom<&Connectors> for BospayAuthData {
    type Error = error_stack::Report<errors::ConnectorError>;
    ...
    fn try_from(
        ...
        match second_factor {
            ...
            None => {
                ...
                Ok(Self {
                    status,
                    response: Err(orbit_domain_models::router_data::ErrorResponse {
    ...
    for types::RefundsRouterData<Execute>
{
    ...
    fn try_from(
        ...
        let response = match epg_txn_id {
            ...
            None => Err(orbit_domain_models::router_data::ErrorResponse {
                code: item
                    .response
                    .refund
                    .error_message
