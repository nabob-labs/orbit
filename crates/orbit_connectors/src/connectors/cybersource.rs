...
#[cfg(feature = "payouts")]
use orbit_interfaces::types::PayoutFulfillType;
...
impl ConnectorCommon for Cybersource {
    ...
    fn build_error_response(
        ...
        let error_message = if res.status_code == 401 {
            ...
            orbit_interfaces::consts::NO_ERROR_MESSAGE
        };
        match response {
                    ...
                    None => {
                        ...
                        (
                            response.reason.clone().map_or(
                                orbit_interfaces::consts::NO_ERROR_CODE.to_string(),
            ...
            Ok(transformers::CybersourceErrorResponse::AuthenticationError(response)) => {
                ...
                Ok(ErrorResponse {
                    status_code: res.status_code,
                    code: orbit_interfaces::consts::NO_ERROR_CODE.to_string(),
