    ...
    > {
        ...
        let mandate_reference =
            notif
                ...
                .map(|mandate_id| {
                    orbit_domain_models::router_flow_types::ConnectorMandateDetails {
    ...
    > {
        ...
        let optional_network_txn_id =
            notif
                ...
                .map(|network_txn_id| {
                    orbit_domain_models::router_flow_types::ConnectorNetworkTxnId::new(
                        network_txn_id,
                    )
                });
