...
use orbit_interfaces::{api::CurrencyUnit, errors};
...
fn make_card_request(
    ...
    ccard: &orbit_domain_models::payment_method_data::Card,
...
fn get_address(
    billing: &orbit_domain_models::address::Address,
) -> Option<(
    &orbit_domain_models::address::Address,
    &orbit_domain_models::address::AddressDetails,
)> {
...
fn build_customer_info(
    billing_address: &orbit_domain_models::address::Address,
    email: &Option<Email>,
...
impl From<orbit_domain_models::address::AddressDetails> for BillingAddress {
    fn from(value: orbit_domain_models::address::AddressDetails) -> Self {
        Self {
            city: value.city,
...
impl From<orbit_domain_models::address::AddressDetails> for Shipping {
    fn from(value: orbit_domain_models::address::AddressDetails) -> Self {
        Self {
            city: value.city,
            country_code: value.country,
