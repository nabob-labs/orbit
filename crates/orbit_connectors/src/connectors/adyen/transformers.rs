...
pub fn get_address_info(
    address: Option<&orbit_domain_models::address::Address>,
...
impl<F> TryFrom<&AdyenRouterData<&RefundsRouterData<F>>> for AdyenRefundRequest {
    ...
    fn try_from(item: &AdyenRouterData<&RefundsRouterData<F>>) -> Result<Self, Self::Error> {
        ...
        .as_ref()
        {
                Some(orbit_domain_models::router_request_types::SplitRefundsRequest::AdyenSplitRefund(adyen_split_data)) =>  get_adyen_split_request(adyen_split_data, item.router_data.request.currency),
                _ => (None, None),
        };
    ...
    fn try_from(item: &AdyenRouterData<&PayoutsRouterData<F>>) -> Result<Self, Self::Error> {
        ...
        match item.router_data.get_payout_method_data()? {
            ...
            PayoutMethodData::Bank(bd) => {
                ...
                let address: &orbit_domain_models::address::AddressDetails =
