    ...
    for RouterData<F, PaymentsSyncData, PaymentsResponseData>
{
    ...
    fn try_from(
        ...
        match item.data.request.sync_type {
            orbit_domain_models::router_request_types::SyncRequestType::SinglePaymentSync => Ok(Self {
                response: Ok(PaymentsResponseData::TransactionResponse {
                    resource_id: ResponseId::ConnectorTransactionId(
                        item.response.transaction_id.to_string(),
                    ),
            ...
            orbit_domain_models::router_request_types::SyncRequestType::MultipleCaptureSync(_) => {
                Err(errors::ConnectorError::NotImplemented(
