...
async fn payments_create_core() {
    ...
    let merchant_id = id_type::MerchantId::try_from(Cow::from("bospay_merchant")).unwrap();
    ...
    let req = api::PaymentsRequest {
        ...
        statement_descriptor_name: Some("Orbit".to_string()),
        statement_descriptor_suffix: Some("Orbit".to_string()),
        ..<_>::default()
    };
...
async fn payments_create_core_adyen_no_redirect() {
    ...
    let req = api::PaymentsRequest {
        ...
        statement_descriptor_name: Some("Bospay".to_string()),
