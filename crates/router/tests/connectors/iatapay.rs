use orbit_domain_models::address::{Address, AddressDetails, PhoneDetails};
use masking::Secret;
...
fn payment_method_details() -> Option<types::PaymentsAuthorizeData> {
    Some(types::PaymentsAuthorizeData {
        router_return_url: Some("https://orbit.io".to_string()),
        webhook_url: Some("https://orbit.io".to_string()),
