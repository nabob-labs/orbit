...
pub use orbit_domain_models::router_request_types::authentication::MessageCategory;
...
impl AuthenticationConnectorData {
    ...
    fn convert_connector(
        ...
        match connector_name {
            ...
            enums::AuthenticationConnectors::Bospaythreedsserver => Ok(ConnectorEnum::Old(
                Box::new(connector::Bospaythreedsserver::new()),
            )),
        }
    }
}
