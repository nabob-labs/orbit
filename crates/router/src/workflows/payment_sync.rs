            ...
            _ => {
                ...
                if is_last_retry
                    ...
                    && payment_data
                        ...
                        .is_none()
                {
                    let payment_intent_update = orbit_domain_models::payments::payment_intent::PaymentIntentUpdate::PGStatusUpdate { status: api_models::enums::IntentStatus::Failed,updated_by: merchant_account.storage_scheme.to_string(), incremental_authorization_allowed: Some(false) };
                    let payment_attempt_update =
                        orbit_domain_models::payments::payment_attempt::PaymentAttemptUpdate::ErrorUpdate {
                            connector: None,
