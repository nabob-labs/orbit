...
use orbit_domain_models::{errors::api_error_response, revenue_recovery};
use orbit_interfaces::webhooks as interface_webhooks;
...
pub async fn recovery_incoming_webhook_flow(
    ...
    request_details: &orbit_interfaces::webhooks::IncomingWebhookRequestDetails<'_>,
...
impl RevenueRecoveryInvoice {
    ...
    async fn create_payment_intent(
        ...
        let create_intent_response = Box::pin(payments::payments_intent_core::<
            orbit_domain_models::router_flow_types::payments::PaymentCreateIntent,
            api_payments::PaymentsIntentResponse,
            _,
            _,
            orbit_domain_models::payments::PaymentIntentData<
                orbit_domain_models::router_flow_types::payments::PaymentCreateIntent,
            >,
        >(
            state.clone(),
...
impl RevenueRecoveryAttempt {
    ...
    ) -> CustomResult<Option<revenue_recovery::RecoveryPaymentAttempt>, errors::RevenueRecoveryError>
    {
        let attempt_response = Box::pin(payments::payments_core::<
            orbit_domain_models::router_flow_types::payments::PSync,
            api_payments::PaymentsResponse,
            _,
            _,
            _,
            orbit_domain_models::payments::PaymentStatusData<
                orbit_domain_models::router_flow_types::payments::PSync,
            >,
        >(
            state.clone(),
    ...
    pub fn create_payment_record_request(
        ...
        api_payments::PaymentsAttemptRecordRequest {
            ...
            payment_merchant_connector_id: payment_merchant_connector_account.as_ref().map(|account: &orbit_domain_models::merchant_connector_account::MerchantConnectorAccount| account.id.clone()),
            error,
            description: None,
