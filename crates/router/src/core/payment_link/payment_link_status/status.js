...
function renderStatusDetails(paymentDetails) {
  ...
  switch (status) {
    case "expired":
      statusDetails.imageSource = "https://live.orbit.io/payment-link-assets/failed.png";
      statusDetails.status = translations.paymentLinkExpired;
      statusDetails.message = translations.paymentLinkExpiredMessage;
      break;

    case "succeeded":
      statusDetails.imageSource = "https://live.orbit.io/payment-link-assets/success.png";
    ...
    case "processing":
      statusDetails.imageSource = "https://live.orbit.io/payment-link-assets/pending.png";
