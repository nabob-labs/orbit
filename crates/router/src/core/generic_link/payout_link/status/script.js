...
function renderStatusDetails(payoutDetails) {
  ...
  var statusInfo = {
    statusImageSrc:
      "https://live.orbit.io/payment-link-assets/success.png",
  ...
  switch (status) {
    ...
    case "pending":
      statusInfo.statusImageSrc =
        "https://live.orbit.io/payment-link-assets/pending.png";
    ...
    default:
      statusInfo.statusImageSrc =
        "https://live.orbit.io/payment-link-assets/failed.png";
