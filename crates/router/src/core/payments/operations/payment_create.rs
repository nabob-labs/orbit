...
impl PaymentCreate {
    ...
    pub async fn make_payment_attempt(
        ...
        // TODO: remove once https://github.com/nabob-labs/orbit/issues/7421 is fixed
        ...
        Ok((
            storage::PaymentAttemptNew {
                ...
                net_amount: orbit_domain_models::payments::payment_attempt::NetAmount::from_payments_request(
                    request,
