...
use orbit_domain_models::payments::PaymentConfirmData;
    ...
    for PaymentIntentConfirm
{
    ...
    async fn get_trackers<'a>(
        ...
        let payment_attempt_domain_model =
            orbit_domain_models::payments::payment_attempt::PaymentAttempt::create_domain_model(
                &payment_intent,
                cell_id,
                storage_scheme,
                request,
        ...
        let payment_attempt: orbit_domain_models::payments::payment_attempt::PaymentAttempt =
        ...
        let payment_method_data = request
            ...
            .payment_method_data
            .clone()
            .map(orbit_domain_models::payment_method_data::PaymentMethodData::from);
