...
use orbit_domain_models::payments::PaymentAttemptRecordData;
    ...
    for PaymentAttemptRecord
{
    ...
    async fn get_trackers<'a>(
        ...
        let payment_attempt_domain_model =
            orbit_domain_models::payments::payment_attempt::PaymentAttempt::create_domain_model_using_record_request(
                &payment_intent,
                cell_id,
                storage_scheme,
                request,
        ...
        let revenue_recovery_data = orbit_domain_models::payments::RevenueRecoveryData {
    ...
    for PaymentAttemptRecord
{
        ...
        F: 'b + Send,
    {
        ...
        let payment_intent_update = orbit_domain_models::payments::payment_intent::PaymentIntentUpdate::RecordUpdate
        {
