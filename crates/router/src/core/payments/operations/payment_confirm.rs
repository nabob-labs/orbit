...
#[cfg(all(any(feature = "v1", feature = "v2"), not(feature = "customer_v2")))]
use orbit_domain_models::payments::payment_intent::PaymentIntentUpdateFields;
use orbit_domain_models::router_request_types::unified_authentication_service;
                    ...
                    let connector_mca = state
                        ...
                        let (network_token, authentication_status) = match response.response.clone() {
                            Ok(unified_authentication_service::UasAuthenticationResponseData::PostAuthentication {
                                ...
                                (Some(
                                    orbit_domain_models::payment_method_data::NetworkTokenData {
            ...
            async move {
                m_db.update_payment_attempt_with_attempt_id(
                    ...
                    storage::PaymentAttemptUpdate::ConfirmUpdate {
                        ...
                        net_amount:
                            orbit_domain_models::payments::payment_attempt::NetAmount::new(
