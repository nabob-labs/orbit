...
use orbit_domain_models::payments::payment_attempt::PaymentAttempt;
#[cfg(feature = "v2")]
use orbit_domain_models::payments::{
                    ...
                    (
                        Some(
                            storage::PaymentAttemptUpdate::IncrementalAuthorizationAmountUpdate {
                                net_amount: orbit_domain_models::payments::payment_attempt::NetAmount::new(
            ...
            match router_data.response.clone() {
                Ok(types::PaymentsResponseData::SessionUpdateResponse { status }) => {
                    if status == SessionUpdateStatus::Success {
                        ...
                        let payment_intent_update = orbit_domain_models::payments::payment_intent::PaymentIntentUpdate::SessionResponseUpdate {
...
async fn payment_response_update_tracker<F: Clone, T: types::Capturable>(
    ...
    let additional_payment_method_data = match payment_data.payment_method_data.clone() {
        Some(payment_method_data) => match payment_method_data {
            orbit_domain_models::payment_method_data::PaymentMethodData::Card(_)
            | orbit_domain_models::payment_method_data::PaymentMethodData::CardRedirect(_)
            | orbit_domain_models::payment_method_data::PaymentMethodData::Wallet(_)
            | orbit_domain_models::payment_method_data::PaymentMethodData::PayLater(_)
            | orbit_domain_models::payment_method_data::PaymentMethodData::BankRedirect(_)
            | orbit_domain_models::payment_method_data::PaymentMethodData::BankDebit(_)
            | orbit_domain_models::payment_method_data::PaymentMethodData::BankTransfer(_)
            | orbit_domain_models::payment_method_data::PaymentMethodData::Crypto(_)
            | orbit_domain_models::payment_method_data::PaymentMethodData::MandatePayment
            | orbit_domain_models::payment_method_data::PaymentMethodData::Reward
            | orbit_domain_models::payment_method_data::PaymentMethodData::RealTimePayment(
                _,
            )
            | orbit_domain_models::payment_method_data::PaymentMethodData::MobilePayment(_)
            | orbit_domain_models::payment_method_data::PaymentMethodData::Upi(_)
            | orbit_domain_models::payment_method_data::PaymentMethodData::Voucher(_)
            | orbit_domain_models::payment_method_data::PaymentMethodData::GiftCard(_)
            | orbit_domain_models::payment_method_data::PaymentMethodData::CardToken(_)
            | orbit_domain_models::payment_method_data::PaymentMethodData::OpenBanking(_) => {
                update_additional_payment_data_with_connector_response_pm_data(
            ...
            orbit_domain_models::payment_method_data::PaymentMethodData::NetworkToken(_) => {
                payment_data.payment_attempt.payment_method_data.clone()
            }
            orbit_domain_models::payment_method_data::PaymentMethodData::CardDetailsForNetworkTransactionId(_) => {
                payment_data.payment_attempt.payment_method_data.clone()
            }
        },
        None => None,
...
impl<F: Send + Clone> Operation<F, types::PaymentsCaptureData> for PaymentResponse {
    type Data = orbit_domain_models::payments::PaymentCaptureData<F>;
    fn to_post_update_tracker(
        &self,
    ) -> RouterResult<
...
impl<F: Clone>
    PostUpdateTracker<
        F,
        orbit_domain_models::payments::PaymentCaptureData<F>,
    ...
    > for PaymentResponse
{
    async fn update_tracker<'b>(
        &'b self,
        state: &'b SessionState,
        mut payment_data: orbit_domain_models::payments::PaymentCaptureData<F>,
        response: types::RouterData<F, types::PaymentsCaptureData, types::PaymentsResponseData>,
        key_store: &domain::MerchantKeyStore,
        storage_scheme: enums::MerchantStorageScheme,
    ) -> RouterResult<orbit_domain_models::payments::PaymentCaptureData<F>>
    where
        F: 'b + Send + Sync,
        types::RouterData<F, types::PaymentsCaptureData, types::PaymentsResponseData>:
            orbit_domain_models::router_data::TrackerPostUpdateObjects<
                F,
                types::PaymentsCaptureData,
                orbit_domain_models::payments::PaymentCaptureData<F>,
            >,
    {
        use orbit_domain_models::router_data::TrackerPostUpdateObjects;
