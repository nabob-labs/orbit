    ...
    for PaymentProxyIntent
{
    ...
    async fn get_trackers<'a>(
        ...
        header_payload: &orbit_domain_models::payments::HeaderPayload,
        ...
        let batch_encrypted_data = domain_types::crypto_operation(
            key_manager_state,
            common_utils::type_name!(orbit_domain_models::payments::payment_attempt::PaymentAttempt),
            domain_types::CryptoOperation::BatchEncrypt(
                orbit_domain_models::payments::payment_attempt::FromRequestEncryptablePaymentAttempt::to_encryptable(
                    orbit_domain_models::payments::payment_attempt::FromRequestEncryptablePaymentAttempt {
        ...
        let encrypted_data =
             orbit_domain_models::payments::payment_attempt::FromRequestEncryptablePaymentAttempt::from_encryptable(batch_encrypted_data)
                .change_context(errors::ApiErrorResponse::InternalServerError)
                .attach_printable("Failed while encrypting payment intent details")?;

        let payment_attempt_domain_model: orbit_domain_models::payments::payment_attempt::PaymentAttempt =
            orbit_domain_models::payments::payment_attempt::PaymentAttempt::proxy_create_domain_model(
                &payment_intent,
                cell_id,
                storage_scheme,
                request,
        ...
        let payment_address = orbit_domain_models::payment_address::PaymentAddress::new(
            payment_intent
                .shipping_address
                .clone()
    ...
    for PaymentProxyIntent
{
    ...
    async fn update_trackers<'b>(
        ...
        _header_payload: orbit_domain_models::payments::HeaderPayload,
        ...
        F: 'b + Send,
    {
        ...
        let payment_intent_update =
            orbit_domain_models::payments::payment_intent::PaymentIntentUpdate::ConfirmIntent {
        ...
        let payment_attempt_update = orbit_domain_models::payments::payment_attempt::PaymentAttemptUpdate::ConfirmIntent {
