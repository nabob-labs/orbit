...
#[cfg(feature = "v2")]
use orbit_domain_models::ApiModelToDieselModelConvertor;
use orbit_domain_models::{payments::payment_intent::CustomerData, router_request_types};
#[cfg(feature = "v2")]
        ...
        From<<T as TryFrom<PaymentAdditionalData<'a, F>>>::Error>,
{
    ...
    let router_data = types::RouterData {
        ...
        response: Err(orbit_domain_models::router_data::ErrorResponse::default()),
...
pub async fn construct_payment_router_data_for_authorize<'a>(
    state: &'a SessionState,
    payment_data: orbit_domain_models::payments::PaymentConfirmData<api::Authorize>,
    connector_id: &str,
    merchant_account: &domain::MerchantAccount,
    _key_store: &domain::MerchantKeyStore,
    customer: &'a Option<domain::Customer>,
    ...
    header_payload: Option<orbit_domain_models::payments::HeaderPayload>,
...
pub async fn construct_payment_router_data_for_capture<'a>(
    state: &'a SessionState,
    payment_data: orbit_domain_models::payments::PaymentCaptureData<api::Capture>,
    connector_id: &str,
    merchant_account: &domain::MerchantAccount,
    _key_store: &domain::MerchantKeyStore,
    customer: &'a Option<domain::Customer>,
    ...
    let router_data = types::RouterData {
        ...
        description: payment_data
            ...
            .map(ToOwned::to_owned),
        // TODO: Create unified address
        address: orbit_domain_models::payment_address::PaymentAddress::default(),
        auth_type: payment_data.payment_attempt.authentication_type,
        connector_meta_data: None,
        connector_wallets_details: None,
        request,
...
pub async fn construct_router_data_for_psync<'a>(
    state: &'a SessionState,
    payment_data: orbit_domain_models::payments::PaymentStatusData<api::PSync>,
    connector_id: &str,
    merchant_account: &domain::MerchantAccount,
    _key_store: &domain::MerchantKeyStore,
    customer: &'a Option<domain::Customer>,
...
pub async fn construct_payment_router_data_for_sdk_session<'a>(
    state: &'a SessionState,
    payment_data: orbit_domain_models::payments::PaymentIntentData<api::Session>,
    connector_id: &str,
    merchant_account: &domain::MerchantAccount,
    _key_store: &domain::MerchantKeyStore,
    customer: &'a Option<domain::Customer>,
...
pub async fn construct_payment_router_data_for_setup_mandate<'a>(
    state: &'a SessionState,
    payment_data: orbit_domain_models::payments::PaymentConfirmData<api::SetupMandate>,
    connector_id: &str,
    merchant_account: &domain::MerchantAccount,
    _key_store: &domain::MerchantKeyStore,
    customer: &'a Option<domain::Customer>,
...
impl<F> GenerateResponse<api_models::payments::PaymentsCaptureResponse>
    for orbit_domain_models::payments::PaymentCaptureData<F>
where
    F: Clone,
{
    fn generate_response(
...
impl<F> GenerateResponse<api_models::payments::PaymentsResponse>
    for orbit_domain_models::payments::PaymentConfirmData<F>
where
    F: Clone,
{
    fn generate_response(
...
#[cfg(feature = "v2")]
impl<F> GenerateResponse<api_models::payments::PaymentsResponse>
    for orbit_domain_models::payments::PaymentStatusData<F>
where
    F: Clone,
{
    fn generate_response(
...
impl<F> GenerateResponse<api_models::payments::PaymentAttemptResponse>
    for orbit_domain_models::payments::PaymentAttemptRecordData<F>
where
    F: Clone,
{
    fn generate_response(
        ...
        && payment_attempt.authentication_data.is_some()
    {
        ...
        let mandate_data = payment_data.get_setup_mandate().map(|d| api::MandateData {
            customer_acceptance: d
                ...
                .map(|d| api::CustomerAcceptance {
                    acceptance_type: match d.acceptance_type {
                        orbit_domain_models::mandates::AcceptanceType::Online => {
                            api::AcceptanceType::Online
                        }
                        orbit_domain_models::mandates::AcceptanceType::Offline => {
            ...
            mandate_type: d.mandate_type.clone().map(|d| match d {
                orbit_domain_models::mandates::MandateDataType::MultiUse(Some(i)) => {
                ...
                orbit_domain_models::mandates::MandateDataType::SingleUse(i) => {
                ...
                orbit_domain_models::mandates::MandateDataType::MultiUse(None) => {
...
impl
    ForeignFrom<(
        &orbit_domain_models::payments::AmountDetails,
        &orbit_domain_models::payments::payment_attempt::AttemptAmountDetails,
...
impl
    ForeignFrom<(
        &orbit_domain_models::payments::AmountDetails,
        Option<&orbit_domain_models::payments::payment_attempt::AttemptAmountDetails>,
    )> for api_models::payments::PaymentAmountDetailsResponse
{
    fn foreign_from(
        (intent_amount_details, attempt_amount_details): (
...
#[cfg(feature = "v2")]
impl ForeignFrom<&orbit_domain_models::payments::payment_attempt::PaymentAttempt>
    for api_models::payments::PaymentAttemptResponse
{
    fn foreign_from(
        attempt: &orbit_domain_models::payments::payment_attempt::PaymentAttempt,
    ) -> Self {
        Self {
...
#[cfg(feature = "v2")]
impl ForeignFrom<&orbit_domain_models::payments::payment_attempt::AttemptAmountDetails>
    for api_models::payments::PaymentAttemptAmountDetails
{
    fn foreign_from(
        amount: &orbit_domain_models::payments::payment_attempt::AttemptAmountDetails,
    ) -> Self {
        Self {
...
#[cfg(feature = "v2")]
impl ForeignFrom<&orbit_domain_models::payments::payment_attempt::ErrorDetails>
    for api_models::payments::ErrorDetails
{
    fn foreign_from(
        error_details: &orbit_domain_models::payments::payment_attempt::ErrorDetails,
    ) -> Self {
        Self {
...
impl
    ForeignFrom<
        &orbit_domain_models::payments::payment_attempt::PaymentAttemptFeatureMetadata,
    > for api_models::payments::PaymentAttemptFeatureMetadata
{
    fn foreign_from(
        feature_metadata: &orbit_domain_models::payments::payment_attempt::PaymentAttemptFeatureMetadata,
    ) -> Self {
...
#[cfg(feature = "v2")]
impl ForeignFrom<orbit_domain_models::payments::AmountDetails>
    for api_models::payments::AmountDetailsResponse
{
    fn foreign_from(amount_details: orbit_domain_models::payments::AmountDetails) -> Self {
        Self {
