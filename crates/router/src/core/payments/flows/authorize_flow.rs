...
use orbit_domain_models::errors::api_error_response::ApiErrorResponse;
#[cfg(feature = "v2")]
...
impl RouterDataAuthorize for types::PaymentsAuthorizeRouterData {
    fn decide_authentication_type(&mut self) {
        if let orbit_domain_models::payment_method_data::PaymentMethodData::Wallet(
            orbit_domain_models::payment_method_data::WalletData::GooglePay(google_pay_data),
...
impl mandate::MandateBehaviour for types::PaymentsAuthorizeData {
    ...
    fn get_setup_mandate_details(
        &self,
    ) -> Option<&orbit_domain_models::mandates::MandateData> {
