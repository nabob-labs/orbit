...
#[cfg(all(any(feature = "v1", feature = "v2"), not(feature = "customer_v2")))]
use orbit_domain_models::api::{GenericLinks, GenericLinksData};
#[cfg(all(
    feature = "v2",
    feature = "payment_methods_v2",
    feature = "customer_v2"
))]
use orbit_domain_models::mandates::CommonMandateReference;
#[cfg(all(feature = "v2", feature = "payment_methods_v2"))]
use orbit_domain_models::payment_method_data;
...
pub async fn add_payment_method_status_update_task(
    ...
    let process_tracker_entry = storage::ProcessTrackerNew::new(
        ...
        None,
        schedule_time,
        orbit_domain_models::consts::API_VERSION,
    )
    .change_context(errors::ApiErrorResponse::InternalServerError)
...
pub(crate) async fn get_payment_method_create_request(
    ...
    payment_method_billing_address: Option<&orbit_domain_models::address::Address>,
) -> RouterResult<payment_methods::PaymentMethodCreate> {
    match payment_method_data {
...
impl PerformFilteringOnEnabledPaymentMethods
    for orbit_domain_models::merchant_connector_account::FlattenedPaymentMethodsEnabled
{
    fn perform_filtering(self) -> FilteredPaymentMethodsEnabled {
...
pub async fn list_payment_methods_for_session(
    ...
    let response =
        orbit_domain_models::merchant_connector_account::FlattenedPaymentMethodsEnabled::from_payment_connectors_list(payment_connector_accounts)
            .perform_filtering()
    ...
    Ok(orbit_domain_models::api::ApplicationResponse::Json(
        response,
    ))
}
...
struct FilteredPaymentMethodsEnabled(
    Vec<orbit_domain_models::merchant_connector_account::PaymentMethodsEnabledForConnector>,
);
...
trait GetRequiredFields {
    fn get_required_fields(
        &self,
        payment_method_enabled: &orbit_domain_models::merchant_connector_account::PaymentMethodsEnabledForConnector,
...
pub async fn create_payment_method_for_intent(
    ...
    payment_method_billing_address: Option<
        Encryptable<orbit_domain_models::address::Address>,
    >,
...
fn create_connector_token_details_update(
    ...
    payment_method: &domain::PaymentMethod,
) -> orbit_domain_models::mandates::CommonMandateReference {
    let connector_id = token_details.connector_id.clone();

    let reference_record =
        orbit_domain_models::mandates::ConnectorTokenReferenceRecord::foreign_from(
            token_details,
        );
    ...
    match connector_token_details {
        ...
        None => {
            ...
            let payments_mandate_reference =
                orbit_domain_models::mandates::PaymentsTokenReference(
...
impl EncryptableData for payment_methods::PaymentMethodSessionRequest {
    type Output = orbit_domain_models::payment_methods::DecryptedPaymentMethodSession;
    ...
    async fn encrypt_data(
        ...
        let batch_encrypted_data = domain_types::crypto_operation(
            key_manager_state,
            common_utils::type_name!(orbit_domain_models::payment_methods::PaymentMethodSession),
            domain_types::CryptoOperation::BatchEncrypt(
                orbit_domain_models::payment_methods::FromRequestEncryptablePaymentMethodSession::to_encryptable(
                    orbit_domain_models::payment_methods::FromRequestEncryptablePaymentMethodSession {
        ...
        let encrypted_data =
        orbit_domain_models::payment_methods::FromRequestEncryptablePaymentMethodSession::from_encryptable(
...
pub async fn payment_methods_session_create(
    ...
    let payment_method_session_domain_model =
        orbit_domain_models::payment_methods::PaymentMethodSession {
...
pub async fn payment_methods_session_update(
    ...
    let payment_method_session_domain_model =
        orbit_domain_models::payment_methods::PaymentMethodsSessionUpdateEnum::GeneralUpdate{
            billing,
            psp_tokenization: request.psp_tokenization,
            network_tokenization: request.network_tokenization,
        };
...
fn construct_zero_auth_payments_request(
    ...
    payment_method_session: &orbit_domain_models::payment_methods::PaymentMethodSession,
...
async fn create_zero_auth_payment(
    ...
    let response = Box::pin(payments_core::payments_create_and_confirm_intent(
        ...
        key_store,
        request,
        orbit_domain_models::payments::HeaderPayload::default(),
        None,
    ))
    .await?;
