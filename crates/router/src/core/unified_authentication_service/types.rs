...
pub trait UnifiedAuthenticationService<F: Clone + Sync> {
    ...
    ) -> RouterResult<orbit_domain_models::types::UasPreAuthenticationRouterData> {
        Err(errors::ApiErrorResponse::NotImplemented {
    ...
    fn get_authentication_request_data(
        ...
        _billing_address: orbit_domain_models::address::Address,
        _shipping_address: Option<orbit_domain_models::address::Address>,
    ...
    async fn authentication(
        ...
        _merchant_connector_account: &MerchantConnectorAccountType,
        _connector_name: &str,
    ) -> RouterResult<orbit_domain_models::types::UasAuthenticationRouterData> {
        Err(errors::ApiErrorResponse::NotImplemented {
    ...
    async fn post_authentication(
        ...
        _payment_method: common_enums::PaymentMethod,
        _authentication: Option<diesel_models::authentication::Authentication>,
    ) -> RouterResult<orbit_domain_models::types::UasPostAuthenticationRouterData> {
        Err(errors::ApiErrorResponse::NotImplemented {
            message: NotImplementedMessage::Reason("post_authentication".to_string()),
        }
        .into())
