...
use orbit_connectors::connectors::chargebee;
use orbit_domain_models::merchant_connector_account::{
...
impl ConnectorAuthTypeAndMetadataValidation<'_> {
    ...
    fn validate_auth_and_metadata_type_with_connector(
        ...
        match self.connector_name {
            ...
            api_enums::Connector::Bospaythreedsserver => Ok(()),
...
impl ConnectorAuthTypeValidation<'_> {
    fn validate_connector_auth_type(
        ...
        match self.auth_type {
            orbit_domain_models::router_data::ConnectorAuthType::TemporaryAuth => Ok(()),
            orbit_domain_models::router_data::ConnectorAuthType::HeaderKey { api_key } => {
                validate_non_empty_field(api_key.peek(), "api_key")
            }
            orbit_domain_models::router_data::ConnectorAuthType::BodyKey {
                api_key,
                key1,
            } => {
                validate_non_empty_field(api_key.peek(), "api_key")?;
            ...
            orbit_domain_models::router_data::ConnectorAuthType::SignatureKey {
                api_key,
                key1,
                api_secret,
            } => {
            ...
            orbit_domain_models::router_data::ConnectorAuthType::MultiAuthKey {
                api_key,
                key1,
                api_secret,
                key2,
            ...
            orbit_domain_models::router_data::ConnectorAuthType::CurrencyAuthKey {
                auth_key_map,
            } => {
            ...
            orbit_domain_models::router_data::ConnectorAuthType::CertificateAuth {
                certificate,
                private_key,
            } => {
            ...
            orbit_domain_models::router_data::ConnectorAuthType::NoKey => Ok(()),
        }
    }
}
