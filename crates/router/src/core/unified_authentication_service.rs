...
impl<F: Clone + Sync> UnifiedAuthenticationService<F> for ClickToPay {
    fn get_pre_authentication_request_data(
        ...
        let service_details = orbit_domain_models::router_request_types::unified_authentication_service::CtpServiceDetails {
    ...
    async fn confirmation(
        ...
        let authentication_confirmation_router_data : orbit_domain_models::types::UasAuthenticationConfirmationRouterData = utils::construct_uas_router_data(
            state,
            connector_name.to_string(),
            payment_method,
            payment_data.payment_attempt.merchant_id.clone(),
...
impl<F: Clone + Sync> UnifiedAuthenticationService<F> for ExternalAuthentication {
    ...
    fn get_authentication_request_data(
        ...
        shipping_address: Option<orbit_domain_models::address::Address>,
