...
use orbit_domain_models::errors::api_error_response as errors;
...
pub enum StripeErrorCode {
    ...
    */
    ...
    #[error(error_type = StripeErrorType::OrbitError, code = "", message = "The connector provided in the request is incorrect or not available")]
    IncorrectConnectorNameGiven,
    #[error(error_type = StripeErrorType::OrbitError, code = "", message = "No such {object}: '{id}'")]
    ResourceMissing { object: String, id: String },
    #[error(error_type = StripeErrorType::OrbitError, code = "", message = "File validation failed")]
    FileValidationFailed,
    #[error(error_type = StripeErrorType::OrbitError, code = "", message = "File not found in the request")]
    MissingFile,
    #[error(error_type = StripeErrorType::OrbitError, code = "", message = "File puropse not found in the request")]
    MissingFilePurpose,
    #[error(error_type = StripeErrorType::OrbitError, code = "", message = "File content type not found")]
    MissingFileContentType,
    #[error(error_type = StripeErrorType::OrbitError, code = "", message = "Dispute id not found in the request")]
    MissingDisputeId,
    #[error(error_type = StripeErrorType::OrbitError, code = "", message = "File does not exists in our records")]
    FileNotFound,
    #[error(error_type = StripeErrorType::OrbitError, code = "", message = "File not available")]
    FileNotAvailable,
    ...
    #[error(error_type = StripeErrorType::OrbitError, code = "", message = "There was an issue with processing webhooks")]
    ...
    #[error(error_type = StripeErrorType::OrbitError, code = "", message = "{message}")]
    OrbitUnprocessableEntity { message: String },
    #[error(error_type = StripeErrorType::InvalidRequestError, code = "", message = "{message}")]
    CurrencyNotSupported { message: String },
    #[error(error_type = StripeErrorType::OrbitError, code = "", message = "Payment Link does not exist in our records")]
    PaymentLinkNotFound,
    #[error(error_type = StripeErrorType::OrbitError, code = "", message = "Resource Busy. Please try again later")]
    LockTimeout,
    ...
    #[error(error_type = StripeErrorType::OrbitError, code = "HE_01", message = "Failed to convert currency to minor unit")]
    ...
    InvalidTenant,
    #[error(error_type = StripeErrorType::OrbitError, code = "HE_01", message = "Failed to convert amount to {amount_type} type")]
    AmountConversionFailed { amount_type: &'static str },
    #[error(error_type = StripeErrorType::OrbitError, code = "", message = "Platform Bad Request")]
    PlatformBadRequest,
    #[error(error_type = StripeErrorType::OrbitError, code = "", message = "Platform Unauthorized Request")]
    PlatformUnauthorizedRequest,
    // [#216]: https://github.com/nabob-labs/orbit/issues/216
    ...
    fn from(value: errors::ApiErrorResponse) -> Self {
        match value {
            ...
            errors::ApiErrorResponse::UnprocessableEntity { message } => {
                Self::OrbitUnprocessableEntity { message }
            }
...
impl actix_web::ResponseError for StripeErrorCode {
    fn status_code(&self) -> reqwest::StatusCode {
        ...
        match self {
            ...
            Self::ParameterUnknown { .. } | Self::OrbitUnprocessableEntity { .. } => {
