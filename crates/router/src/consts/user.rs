...
/// Email subject
pub const EMAIL_SUBJECT_SIGNUP: &str = "Welcome to the Orbit community!";
pub const EMAIL_SUBJECT_INVITATION: &str = "You have been invited to join Orbit Community!";
pub const EMAIL_SUBJECT_MAGIC_LINK: &str = "Unlock Orbit: Use Your Magic Link to Sign In";
pub const EMAIL_SUBJECT_RESET_PASSWORD: &str = "Get back to Orbit - Reset Your Password Now";
pub const EMAIL_SUBJECT_NEW_PROD_INTENT: &str = "New Prod Intent";
pub const EMAIL_SUBJECT_WELCOME_TO_COMMUNITY: &str =
    "Thank you for signing up on Orbit Dashboard!";
