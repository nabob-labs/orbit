...
use orbit_domain_models::payments::HeaderPayload;
...
pub async fn payments_create_intent(
    ...
    use orbit_domain_models::payments::PaymentIntentData;
    ...
    Box::pin(api::server_wrap(
        ...
        |state, auth: auth::AuthenticationData, req, _| {
            payments::payment_external_authentication::<
                orbit_domain_models::router_flow_types::Authenticate,
...
pub async fn payment_status(
    ...
    use orbit_domain_models::payments::PaymentStatusData;
