...
pub fn get_authorize_page(
    ...
    html! {
        ...
        body {
            div.heading {
                img.logo src="https://app.orbit.io/assets/Dark/orbitLogoIconWithText.svg" alt="Orbit Logo" {}
            ...
            div.container {
                ...
                div.contact {
                    div.contact_item.hover_cursor onclick=(dummy_connector_conf.slack_invite_url) {
                        img src="https://orbit.io/logos/logo_slack.svg" alt="Slack Logo" {}
                    }
                    div.contact_item.hover_cursor onclick=(dummy_connector_conf.discord_invite_url) {
                        img src="https://orbit.io/logos/logo_discord.svg" alt="Discord Logo" {}
                    }
                    div.border_vertical {}
                    div.contact_item.email {
                        p { "Or email us at" }
                        a href="mailto:mailto:orbit@xyz.in" { "mailto:orbit@xyz.in" }
                    }
                }
            }
        }
...
pub fn get_expired_page(dummy_connector_conf: &settings::DummyConnector) -> String {
    html! {
        head {
            title { "Authorize Payment" }
            style { (consts::THREE_DS_CSS) }
            link rel="icon" href="https://app.orbit.io/OrbitFavicon.png" {}
        }
        body {
            div.heading {
                img.logo src="https://app.orbit.io/assets/Dark/orbitLogoIconWithText.svg" alt="Orbit Logo" {}
            ...
            div.container {
                ...
                div.contact {
                    ...
                    div.contact_item.email {
                        p { "Or email us at" }
                        a href="mailto:orbit@xyz.in" { "mailto:orbit@xyz.in" }
                    }
                }
            }
        }
