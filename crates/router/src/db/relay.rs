...
pub trait RelayInterface {
    async fn insert_relay(
        ...
        new: orbit_domain_models::relay::Relay,
    ) -> CustomResult<orbit_domain_models::relay::Relay, errors::StorageError>;

    async fn update_relay(
        &self,
        key_manager_state: &KeyManagerState,
        merchant_key_store: &domain::MerchantKeyStore,
        current_state: orbit_domain_models::relay::Relay,
        relay_update: orbit_domain_models::relay::RelayUpdate,
    ) -> CustomResult<orbit_domain_models::relay::Relay, errors::StorageError>;
...
impl RelayInterface for MockDb {
    async fn insert_relay(
        ...
        _new: orbit_domain_models::relay::Relay,
    ) -> CustomResult<orbit_domain_models::relay::Relay, errors::StorageError> {
    ...
    async fn update_relay(
        ...
        _key_manager_state: &KeyManagerState,
        _merchant_key_store: &domain::MerchantKeyStore,
        _current_state: orbit_domain_models::relay::Relay,
        _relay_update: orbit_domain_models::relay::RelayUpdate,
    ) -> CustomResult<orbit_domain_models::relay::Relay, errors::StorageError> {
        Err(errors::StorageError::MockDbError)?
    }
