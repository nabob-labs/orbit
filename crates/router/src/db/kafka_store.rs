...
#[cfg(feature = "payouts")]
use orbit_domain_models::payouts::{
...
use orbit_domain_models::{PayoutAttemptInterface, PayoutsInterface};
use masking::Secret;
...
impl PaymentAttemptInterface for KafkaStore {
    ...
    async fn get_filters_for_payments(
        &self,
        pi: &[orbit_domain_models::payments::PaymentIntent],
        merchant_id: &id_type::MerchantId,
        storage_scheme: MerchantStorageScheme,
    ) -> CustomResult<
        orbit_domain_models::payments::payment_attempt::PaymentListFilters,
...
impl PaymentIntentInterface for KafkaStore {
    ...
    async fn filter_payment_intent_by_constraints(
        ...
        state: &KeyManagerState,
        merchant_id: &id_type::MerchantId,
        filters: &orbit_domain_models::payments::payment_intent::PaymentIntentFetchConstraints,
        key_store: &domain::MerchantKeyStore,
        storage_scheme: MerchantStorageScheme,
    ...
    async fn get_filtered_payment_intents_attempt(
        ...
        state: &KeyManagerState,
        merchant_id: &id_type::MerchantId,
        constraints: &orbit_domain_models::payments::payment_intent::PaymentIntentFetchConstraints,
        key_store: &domain::MerchantKeyStore,
        storage_scheme: MerchantStorageScheme,
    ) -> CustomResult<
        Vec<(
            orbit_domain_models::payments::PaymentIntent,
            orbit_domain_models::payments::payment_attempt::PaymentAttempt,
        )>,
        errors::DataStorageError,
    > {
        self.diesel_store
    ...
    async fn get_filtered_payment_intents_attempt(
        ...
        Vec<(
            orbit_domain_models::payments::PaymentIntent,
            Option<orbit_domain_models::payments::payment_attempt::PaymentAttempt>,
        )>,
        errors::DataStorageError,
    > {
        self.diesel_store
...
impl PayoutAttemptInterface for KafkaStore {
    ...
    async fn get_filters_for_payouts(
        &self,
        payouts: &[orbit_domain_models::payouts::payouts::Payouts],
        merchant_id: &id_type::MerchantId,
        storage_scheme: MerchantStorageScheme,
    ) -> CustomResult<
        orbit_domain_models::payouts::payout_attempt::PayoutListFilters,
        errors::DataStorageError,
    > {
        self.diesel_store
...
impl PayoutsInterface for KafkaStore {
    ...
    async fn filter_payouts_by_constraints(
        &self,
        merchant_id: &id_type::MerchantId,
        filters: &orbit_domain_models::payouts::PayoutFetchConstraints,
        storage_scheme: MerchantStorageScheme,
    ...
    async fn filter_active_payout_ids_by_constraints(
        &self,
        merchant_id: &id_type::MerchantId,
        constraints: &orbit_domain_models::payouts::PayoutFetchConstraints,
    ) -> CustomResult<Vec<String>, errors::DataStorageError> {
        self.diesel_store
...
impl BatchSampleDataInterface for KafkaStore {
    ...
    async fn insert_payment_intents_batch_for_sample_data(
        &self,
        state: &KeyManagerState,
        batch: Vec<orbit_domain_models::payments::PaymentIntent>,
        key_store: &orbit_domain_models::merchant_key_store::MerchantKeyStore,
    ) -> CustomResult<
        Vec<orbit_domain_models::payments::PaymentIntent>,
        orbit_domain_models::errors::StorageError,
    > {
    ...
    async fn insert_payment_attempts_batch_for_sample_data(
        ...
        Vec<orbit_domain_models::payments::payment_attempt::PaymentAttempt>,
        orbit_domain_models::errors::StorageError,
    > {
    ...
    ) -> CustomResult<Vec<diesel_models::Refund>, orbit_domain_models::errors::StorageError>
    {
    ...
    ) -> CustomResult<Vec<diesel_models::Dispute>, orbit_domain_models::errors::StorageError>
    {
...
impl db::payment_method_session::PaymentMethodsSessionInterface for KafkaStore {
    async fn insert_payment_methods_session(
        ...
        state: &KeyManagerState,
        key_store: &orbit_domain_models::merchant_key_store::MerchantKeyStore,
        payment_methods_session: orbit_domain_models::payment_methods::PaymentMethodSession,
        validity: i64,
    ) -> CustomResult<(), errors::StorageError> {
        self.diesel_store
    ...
    async fn update_payment_method_session(
        ...
        key_store: &orbit_domain_models::merchant_key_store::MerchantKeyStore,
        id: &id_type::GlobalPaymentMethodSessionId,
        payment_methods_session: orbit_domain_models::payment_methods::PaymentMethodsSessionUpdateEnum,
        current_session: orbit_domain_models::payment_methods::PaymentMethodSession,
    ) -> CustomResult<
        orbit_domain_models::payment_methods::PaymentMethodSession,
        errors::StorageError,
    > {
