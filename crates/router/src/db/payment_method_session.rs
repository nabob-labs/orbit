...
mod storage {
    ...
    use orbit_domain_models::behaviour::{Conversion, ReverseConversion};
    ...
    impl PaymentMethodsSessionInterface for Store {
        ...
        async fn insert_payment_methods_session(
            ...
            _key_store: &orbit_domain_models::merchant_key_store::MerchantKeyStore,
            payment_methods_session: orbit_domain_models::payment_methods::PaymentMethodSession,
        ...
        async fn update_payment_method_session(
            ...
            update_request: orbit_domain_models::payment_methods::PaymentMethodsSessionUpdateEnum,
            current_session: orbit_domain_models::payment_methods::PaymentMethodSession,
        ) -> CustomResult<
            orbit_domain_models::payment_methods::PaymentMethodSession,
            errors::StorageError,
        > {
            ...
            let internal_obj = orbit_domain_models::payment_methods::PaymentMethodsSessionUpdateInternal::from(update_request);
