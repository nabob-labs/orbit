...
impl api::IncomingWebhook for ConnectorEnum {
    ...
    fn get_mandate_details(
        ...
        Option<orbit_domain_models::router_flow_types::ConnectorMandateDetails>,
    ...
    fn get_network_txn_id(
        ...
        Option<orbit_domain_models::router_flow_types::ConnectorNetworkTxnId>,
        errors::ConnectorError,
    > {
        match self {
    ...
    fn get_revenue_recovery_attempt_details(
        ...
        orbit_domain_models::revenue_recovery::RevenueRecoveryAttemptData,
        errors::ConnectorError,
    > {
        match self {
    ...
    fn get_revenue_recovery_invoice_details(
        ...
        orbit_domain_models::revenue_recovery::RevenueRecoveryInvoiceData,
        errors::ConnectorError,
    > {
        match self {
...
impl api::ConnectorTransactionId for ConnectorEnum {
    fn connector_transaction_id(
        &self,
        payment_attempt: orbit_domain_models::payments::payment_attempt::PaymentAttempt,
...
impl ConnectorValidation for ConnectorEnum {
    ...
    fn validate_psync_reference_id(
        &self,
        data: &orbit_domain_models::router_request_types::PaymentsSyncData,
        is_three_ds: bool,
