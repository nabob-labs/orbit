...
use orbit_domain_models::router_data_v2::flow_common_types as common_types;
...
impl EmbedError
    for Report<orbit_domain_models::errors::api_error_response::ApiErrorResponse>
{
}
