...
pub use orbit_interfaces::configs::Connectors;
use orbit_interfaces::secrets_interface::secret_state::{
...
// Todo: Global tenant should not be part of tenant config(https://github.com/nabob-labs/orbit/issues/7237)
#[derive(Debug, Deserialize, Clone)]
...
impl Default for GenericLinkEnvUiConfig {
    fn default() -> Self {
        Self {
            #[allow(clippy::expect_used)]
            logo: url::Url::parse("https://orbit.io/favicon.ico")
                .expect("Failed to parse default logo URL"),
            merchant_name: Secret::new("Orbit".to_string()),
