...
use orbit_connectors::utils::AddressDetailsData;
...
impl
    TryFrom<(
        ...
        Option<orbit_domain_models::address::Address>,
    )> for Cardholder
{
    type Error = error_stack::Report<errors::ConnectorError>;
    fn try_from(
...
impl TryFrom<orbit_domain_models::address::PhoneDetails> for PhoneNumber {
    type Error = error_stack::Report<errors::ConnectorError>;
    fn try_from(
        value: orbit_domain_models::address::PhoneDetails,
    ) -> Result<Self, Self::Error> {
        Ok(Self {
