...
pub trait RouterData {
    fn get_billing(&self) -> Result<&orbit_domain_models::address::Address, Error>;
    fn get_billing_country(&self) -> Result<api_models::enums::CountryAlpha2, Error>;
    fn get_billing_phone(&self)
        -> Result<&orbit_domain_models::address::PhoneDetails, Error>;
    fn get_description(&self) -> Result<String, Error>;
    fn get_billing_address(
        &self,
    ) -> Result<&orbit_domain_models::address::AddressDetails, Error>;
    fn get_shipping_address(
        &self,
    ) -> Result<&orbit_domain_models::address::AddressDetails, Error>;
    fn get_shipping_address_with_phone_number(
        &self,
    ) -> Result<&orbit_domain_models::address::Address, Error>;
    ...
    fn get_optional_billing(&self) -> Option<&orbit_domain_models::address::Address>;
    fn get_optional_shipping(&self) -> Option<&orbit_domain_models::address::Address>;
...
impl AddressData for orbit_domain_models::address::Address {
    fn get_email(&self) -> Result<Email, Error> {
...
impl CardData
    for orbit_domain_models::payment_method_data::CardDetailsForNetworkTransactionId
{
    fn get_card_expiry_year_2_digit(&self) -> Result<Secret<String>, errors::ConnectorError> {
...
impl PhoneDetailsData for orbit_domain_models::address::PhoneDetails {
    fn get_country_code(&self) -> Result<String, Error> {
        self.country_code
            .clone()
...
impl AddressDetailsData for orbit_domain_models::address::AddressDetails {
    fn get_first_name(&self) -> Result<&Secret<String>, Error> {
        self.first_name
            .as_ref()
    ...
    fn from(pm_data: domain::payments::PaymentMethodData) -> Self {
        match pm_data {
            ...
            domain::PaymentMethodData::RealTimePayment(real_time_payment_data) => match *real_time_payment_data{
                orbit_domain_models::payment_method_data::RealTimePaymentData::DuitNow {  } =>  Self::DuitNow,
                orbit_domain_models::payment_method_data::RealTimePaymentData::Fps {  } => Self::Fps,
                orbit_domain_models::payment_method_data::RealTimePaymentData::PromptPay {  } => Self::PromptPay,
                orbit_domain_models::payment_method_data::RealTimePaymentData::VietQr {  } => Self::VietQr,
            },
            ...
            domain::payments::PaymentMethodData::OpenBanking(data) => match data {
                orbit_domain_models::payment_method_data::OpenBankingData::OpenBankingPIS {  } => Self::OpenBanking
            },
            domain::payments::PaymentMethodData::MobilePayment(mobile_payment_data) => match mobile_payment_data {
                orbit_domain_models::payment_method_data::MobilePaymentData::DirectCarrierBilling { .. } => Self::DirectCarrierBilling,
            },
        }
    }
}
