...
pub struct MerchantConnectorCreate {
    ...
    /// This is an unique label you can generate and pass in order to identify this connector account on your Orbit dashboard and reports, If not passed then if will take `connector_name`_`profile_name`. Eg: if your profile label is `default`, connector label can be `stripe_default`
...
pub struct MerchantConnectorCreate {
    ...
    #[schema(value_type = Connector, example = "stripe")]
    pub connector_name: api_enums::Connector,
    /// This is an unique label you can generate and pass in order to identify this connector account on your Orbit dashboard and reports. Eg: if your profile label is `default`, connector label can be `stripe_default`
    #[schema(example = "stripe_US_travel")]
    pub connector_label: Option<String>,
...
pub struct BusinessPaymentLinkConfig {
    ...
    /// Toggle for Orbit branding visibility
...
pub struct PaymentLinkConfigRequest {
    ...
    #[schema(value_type = Option<String>, max_length = 255, example = "orbit")]
...
pub struct PaymentLinkBackgroundImageConfig {
    /// URL of the image
    #[schema(value_type = String, example = "https://orbit.io/favicon.ico")]
