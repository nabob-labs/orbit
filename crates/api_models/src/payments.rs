...
pub struct PaymentsCreateIntentRequest {
    ...
    #[schema(value_type = Option<String>, example = "https://orbit.io")]
    ...
    #[schema(max_length = 22, example = "Orbit Router", value_type = Option<String>)]
    ...
    /// Additional data that might be required by orbit based on the requested features by the merchants.
...
pub struct AmountDetails {
    /// The payment amount. Amount for the payment in the lowest denomination of the currency, (i.e) in cents for USD denomination, in yen for JPY denomination etc. E.g., Pass 100 to charge $1.00 and 1 for 1¥ since ¥ is a zero-decimal currency. Read more about [the Decimal and Non-Decimal Currencies](https://github.com/nabob-labs/orbit/wiki/Decimal-and-Non%E2%80%90Decimal-Currencies)
...
pub struct PaymentsRequest {
    ...
    /// As Orbit tokenises the sensitive details about the payments method, it provides the payment_token as a reference to a stored payment method, ensuring that the sensitive details are not exposed in any manner.
    ...
    /// For non-card charges, you can use this value as the complete description that appears on your customers’ statements. Must contain at least one letter, maximum 22 characters.
    #[schema(max_length = 255, example = "Orbit Router")]
    ...
    /// In case the connector supports only one reference id, Orbit's Payment ID will be sent as reference.
    #[schema(
        value_type = Option<String>,
        max_length = 255,
...
pub struct PaymentAttemptResponse {
    ...
    /// Additional data that might be required by orbit, to enable some specific features.
...
pub struct PaymentAttemptFeatureMetadata {
    /// Revenue recovery metadata that might be required by orbit.
...
/// Orbit supports SDK integration with Apple Pay and Google Pay wallets. For other wallets, we integrate with their respective connectors, redirecting the customer to the connector for wallet payments. As a result, we don’t receive any payment method data in the confirm call for payments made through other wallets.
#[derive(Debug, Clone, Eq, PartialEq, serde::Deserialize, serde::Serialize, ToSchema)]
#[serde(rename_all = "snake_case")]
...
pub enum NextActionData {
    ...
    QrCodeInformation {
        #[schema(value_type = String)]
        /// Orbit generated image data source url
...
pub struct PaymentsListResponseItem {
    ...
    /// The URL to redirect after the completion of the operation
    #[schema(value_type = String, example = "https://orbit.io")]
    pub return_url: Option<common_utils::types::Url>,

    /// For non-card charges, you can use this value as the complete description that appears on your customers’ statements. Must contain at least one letter, maximum 22 characters.
    #[schema(value_type = Option<String>, max_length = 255, example = "Orbit Router")]
    pub statement_descriptor: Option<common_utils::types::StatementDescriptor>,
...
pub enum PaymentProcessingDetailsAt {
    Orbit(PaymentProcessingDetails),
    Connector,
}
...
// Google Pay Provider Details can of two types: GooglePayMerchantDetails or GooglePayOrbitDetails
// GooglePayOrbitDetails is not implemented yet
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize)]
#[serde(untagged)]
...
/// additional data that might be required by orbit
#[cfg(feature = "v2")]
