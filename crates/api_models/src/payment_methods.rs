...
pub struct PaymentMethodCollectLinkRequest {
    ...
    #[schema(value_type = Option<String>, example = "https://sandbox.orbit.io/payment_method/collect/pm_collect_link_2bdacf398vwzq5n422S1/status")]
...
pub struct PaymentMethodCollectLinkResponse {
    ...
    #[schema(value_type = String, example = "https://sandbox.orbit.io/payment_method/collect/pm_collect_link_2bdacf398vwzq5n422S1")]
