...
use orbit_domain_models::errors::{StorageError, StorageResult};
use opensearch::{
    auth::Credentials,
...
impl Default for OpenSearchConfig {
    fn default() -> Self {
        Self {
            ...
            indexes: OpenSearchIndexes {
                payment_attempts: "orbit-payment-attempt-events".to_string(),
                payment_intents: "orbit-payment-intent-events".to_string(),
                refunds: "orbit-refund-events".to_string(),
                disputes: "orbit-dispute-events".to_string(),
